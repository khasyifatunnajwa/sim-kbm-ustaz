/*
# SIM KBM Ustaz - Initial Schema

1. New Tables
- `murid` - Data santri/murid dengan nama, kelas, domisili, alamat
- `jadwal_mengajar` - Jadwal mengajar ustaz per hari
- `absensi` - Absensi harian santri
- `buku_saku_batas` - Batas mengajar kitab per kelas
- `buku_saku_tagihan` - Target hafalan/tagihan santri
- `catatan_perilaku` - Catatan sikap/prestasi/pelanggaran santri
- `nilai` - Nilai ujian santri
- `bank_soal` - Arsip soal ujian
- `capaian_hafalan` - Capaian setoran hafalan santri
...
DROP POLICY IF EXISTS "select_own_sakubatas" ON buku_saku_batas;
DROP POLICY IF EXISTS "insert_own_sakubatas" ON buku_saku_batas;
DROP POLICY IF EXISTS "update_own_sakubatas" ON buku_saku_batas;
DROP POLICY IF EXISTS "delete_own_sakubatas" ON buku_saku_batas;
...
DROP POLICY IF EXISTS "select_own_sakutagihan" ON buku_saku_tagihan;
DROP POLICY IF EXISTS "insert_own_sakutagihan" ON buku_saku_tagihan;
DROP POLICY IF EXISTS "update_own_sakutagihan" ON buku_saku_tagihan;
DROP POLICY IF EXISTS "delete_own_sakutagihan" ON buku_saku_tagihan;
...
DROP POLICY IF EXISTS "select_own_perilaku" ON catatan_perilaku;
DROP POLICY IF EXISTS "insert_own_perilaku" ON catatan_perilaku;
DROP POLICY IF EXISTS "update_own_perilaku" ON catatan_perilaku;
DROP POLICY IF EXISTS "delete_own_perilaku" ON catatan_perilaku;
...
-- Bank Soal Policies
DROP POLICY IF EXISTS "select_own_soal" ON bank_soal;
DROP POLICY IF EXISTS "insert_own_soal" ON bank_soal;
DROP POLICY IF EXISTS "update_own_soal" ON bank_soal;
DROP POLICY IF EXISTS "delete_own_soal" ON bank_soal;
...
DROP POLICY IF EXISTS "select_own_capaian" ON capaian_hafalan;
DROP POLICY IF EXISTS "insert_own_capaian" ON capaian_hafalan;
DROP POLICY IF EXISTS "update_own_capaian" ON capaian_hafalan;
DROP POLICY IF EXISTS "delete_own_capaian" ON capaian_hafalan;
