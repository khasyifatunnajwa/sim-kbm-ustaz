    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="card p-4">
          ...
          <p className="text-2xl font-bold text-slate-800">{stats.totalToday}</p>
          <p className="text-xs text-slate-400">Total presensi</p>
        </div>
        ...
        <div className="card p-4">
          ...
          <p className="text-2xl font-bold text-amber-600">{stats.terlambat}</p>
          <p className="text-xs text-slate-400">Terlambat hadir</p>
        </div>
        ...
        <div className="card p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-slate-400 font-medium">Belum</span>
          </div>
          <p className="text-2xl font-bold text-rose-600">{stats.belumPresensi}</p>
          <p className="text-xs text-slate-400">Belum presensi</p>
        </div>
      </div>
      ...
      <div className="card p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-slate-700">Persentase Kehadiran Hari Ini</span>
          </div>
          <span className="text-lg font-bold text-emerald-600">{stats.persentase}%</span>
        </div>
